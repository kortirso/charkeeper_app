...
import { Dnd5, Pathfinder2, Daggerheart, Dc20, Fate, Fallout, Cosmere, Cthulhu7, Nimble } from '../../pages';
    ...
    <>
      ...
      <Switch>
        ...
        <Match when={character().provider === 'nimble'}>
          <Nimble character={character()} onReloadCharacter={reloadCharacter} onReplaceCharacter={replaceCharacter} />
        </Match>
      </Switch>
    </>
  );
